...
#gomobile bind -v -x -o build/bukanir.aar -target android/arm,android/arm64,android/386 -ldflags "-s -w -extldflags=-Wl,--allow-multiple-definition" github.com/gen2brain/bukanir/lib/bukanir
...
gomobile bind -v -x -o build/bukanir-arm7.aar -target android/arm -ldflags "-s -w -extldflags=-Wl,--allow-multiple-definition" github.com/gen2brain/bukanir/lib/bukanir 
...
gomobile bind -v -x -o build/bukanir-arm64.aar -target android/arm64 -ldflags "-s -w -extldflags=-Wl,--allow-multiple-definition" github.com/gen2brain/bukanir/lib/bukanir 
...
gomobile bind -v -x -o build/bukanir-x86.aar -target android/386 -ldflags "-s -w -extldflags=-Wl,--allow-multiple-definition" github.com/gen2brain/bukanir/lib/bukanir 
