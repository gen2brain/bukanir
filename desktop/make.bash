...
CGO_CXXFLAGS="-I$CHROOT/usr/include -I$INCPATH -I$INCPATH/QtCore -I$INCPATH/QtGui -I$INCPATH/QtWidgets -I$INCPATH/libtorrent -Wno-unused-parameter -Wno-unused-variable" \
CGO_CXXFLAGS="$CGO_CXXFLAGS -pipe -O2 -std=gnu++11 -Wall -W -D_REENTRANT -DQT_NO_DEBUG -DQT_CORE_LIB -DQT_GUI_LIB -DQT_WIDGETS_LIB -fPIC" \
...
CGO_ENABLED=1 GOOS=linux GOARCH=amd64 go build -tags 'static minimal' -o build/bukanir.amd64 -v -x -ldflags "-s -w"
...
#CGO_CFLAGS="-Wno-unused-parameter -Wno-unused-variable" \
#CGO_CXXFLAGS="-I$INCPATH -I$INCPATH/QtCore -I$INCPATH/QtGui -I$INCPATH/QtWidgets -I$INCPATH/libtorrent -Wno-unused-parameter -Wno-unused-variable" \
#CGO_CXXFLAGS="$CGO_CXXFLAGS -pipe -O2 -std=gnu++11 -Wall -W -D_REENTRANT -DQT_NO_DEBUG -DQT_CORE_LIB -DQT_GUI_LIB -DQT_WIDGETS_LIB -fPIC" \
#CGO_LDFLAGS="-L$CHROOT/usr/lib -L$CHROOT/lib -L$PLUGPATH/platforms -L$PLUGPATH/generic" \
#CGO_LDFLAGS="$CGO_LDFLAGS -lQt5Core -lpthread -lz -lpcre16 -ldouble-conversion -lm -ldl -lgthread-2.0 -lglib-2.0 -lrt" \
#CGO_LDFLAGS="$CGO_LDFLAGS -ljpeg -lQt5Widgets -lQt5Gui -lQt5Core -lpthread -lpng -lharfbuzz -lz -lGL" \
...
#CGO_LDFLAGS="$CGO_LDFLAGS -lvpx -lvorbisenc -lvorbis -logg -ltheoraenc -ltheoradec -logg -lmp3lame -lfdk-aac -lx264 -lx265 -lfaac" \
#CGO_LDFLAGS="$CGO_LDFLAGS -lqxcb -lqevdevkeyboardplugin -lqevdevmouseplugin -lQt5XcbQpa -lQt5PlatformSupport -lQt5DBus -lX11-xcb -lXi -lxcb-render -lxcb-render-util -lXv -lSM -lICE -lXxf86vm -lXcursor -ldbus-1 -lxcb -lxcb-image -lxcb-icccm -lxcb-sync -lxcb-xfixes -lxcb-shm -lxcb-randr -lxcb-shape -lxcb-keysyms -lxcb-xinerama -lxcb-xkb -lxcb-util -lxcb-glx -lxkbcommon-x11 -lxkbcommon  -lfontconfig -lfreetype -ldl -lXrender -lXext -lX11 -lm -ludev -lmtdev -lEGL -lQt5Gui -ljpeg -lpng -lharfbuzz -lz -lbz2 -lGL -lQt5DBus -lQt5Core -lpthread -lGL" \
#CGO_ENABLED=1 GOOS=linux GOARCH=386 go build -tags 'static minimal' -o build/bukanir.386 -v -x -ldflags "-s -w"
...
CGO_CFLAGS="-Wno-unused-parameter -Wno-unused-variable" \
CGO_CXXFLAGS="-I$INCPATH -I$INCPATH/QtCore -I$INCPATH/QtGui -I$INCPATH/QtWidgets -I$INCPATH/libtorrent -Wno-unused-parameter -Wno-unused-variable" \
CGO_CXXFLAGS="$CGO_CXXFLAGS -pipe -O2 -std=gnu++11 -Wall -W -D_REENTRANT -DQT_NO_DEBUG -DQT_CORE_LIB -DQT_GUI_LIB -DQT_WIDGETS_LIB" \
...
CGO_LDFLAGS="$CGO_LDFLAGS -llua -lmpv -lopengl32 -lSDL2 -ljpeg -llua -lass -lharfbuzz -lenca -lavformat -lswscale -lavdevice -lversion -lgdi32 -lopengl32 -lshlwapi -lvfw32 -lwinmm -lstrmiids -lole32 -loleaut32" \
